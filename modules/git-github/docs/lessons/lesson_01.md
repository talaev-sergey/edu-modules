...
!!! slide "Краткая история: откуда взялся Git"
    ...
    ![Линус Торвальдс — создатель Git и Linux](../assets/images/lesson_01_git_history.png)
...
- Если Git уже установлен тьютором, пропустить блоки 1–2 и начать с проверки версии (блок 3).

!!! slide "Блок 1. Скачиваем установщик Git"
    **Мини-теория:** программы для Windows скачивают в виде файла-установщика. Git берут только с официального сайта git-scm.com — так мы не поймаем вирус с поддельного сайта.
    ...
    ![Страница загрузки на git-scm.com: кнопка «Click here to download»](../assets/images/lesson_01_git_download.png)

!!! slide "Блок 2. Устанавливаем Git"
...
!!! slide "Блок 3. Открываем Git Bash и проверяем установку"
    **Мини-теория:** вместе с Git устанавливается терминал Git Bash. Команда `git --version` показывает номер установленной версии — это самый простой способ проверить, что Git работает.
    ...
    ![Запуск Git Bash: поиск в меню «Пуск» и открытое окно терминала](../assets/images/lesson_01_gitbash_open.png)

    ![Git Bash: команда git -v выводит номер версии](../assets/images/lesson_01_gitbash_version.png)
...
!!! slide "Блок 4. Первая настройка Git: имя и e-mail"
    **Мини-теория:** Git подписывает каждое сохранение именем автора, поэтому ему нужно один раз сообщить, кто вы. Эти данные настраиваются командой `git config` и потом используются во всех проектах.
    ...
    ![Git Bash: настройка user.name и user.email и вывод git config -l](../assets/images/lesson_01_git_config.png)

!!! note "Ожидаемый результат"
    Git установлен, открывается Git Bash, команда `git --version` показывает версию, а в настройках записаны имя и e-mail ученика.

!!! slide "Блок 5. Устанавливаем редактор кода VS Code"
...
- Спросить нескольких учеников, какую версию Git показала команда `git --version`.
...
- На школьных компьютерах может не быть прав тьютора — тогда Git и VS Code должен установить тьютор заранее.
...
- Выполнить команду `git --help` и посмотреть, сколько у Git команд. Назвать две незнакомые.
