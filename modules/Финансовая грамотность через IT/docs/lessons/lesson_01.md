...
- Объясняет, что папку на Рабочем столе на этом этапе создавать не обязательно: основная работа будет храниться в Canva.
...
-   ![Платное продвижение поста или объявления](../assets/images/lesson_01/03_catalog.webp)

    **Ситуация 3. Платное продвижение поста или объявления**

    Здесь оплачиваются показы, клики или переходы на страницу, поэтому важно понимать, сколько заявок может принести реклама.
...
| Пакеты | Обычные стикеры, GIF-стикеры и премиум-вариант | Видно, чем отличаются тарифы. |
| Оставить заявку | Место для будущей ссылки на форму | Появляется путь к заказу. |

#### Подготовка проекта

1. Откройте браузер.
2. Перейдите на сайт Canva: <https://www.canva.com/>.
3. Пройдите регистрацию с подтверждением. Временная почта не подойдет.
...
| --- | --- | --- |
| Что входит | Заполнить общий состав услуги | `10 стикеров`, `1 правка` |
| Почему это стоит денег | Заполнить 2 причины | `время на работу`, `подбор стиля под клиента` |
| Пакеты | Заполнить 2 строки и держать в голове премиум-вариант | `Обычные стикеры - 500 рублей`, `GIF-стикеры - 1 000 рублей` |
| Оставить заявку | Добавить место для будущей формы | `На следующих уроках здесь будет кнопка на форму заявки` |

Создайте блок "Что входит в услугу" и заполните его как общий состав базовой услуги, чтобы блок подходил и к обычным, и к GIF-стикерам. Пример: `10 стикеров`, `1 правка`. Не нужно расписывать здесь все тарифы подробно: этот блок показывает, что клиент вообще получает в заказе.

Затем создайте блок "Почему это стоит денег" и заполните 2 причины. Это важный финансовый блок: он объясняет не красоту дизайна, а цену услуги.

Создайте блок "Пакеты" или "Примерный прайс". Заполните 2 строки: `Обычные стикеры - 500 рублей`, `GIF-стикеры - 1 000 рублей`. Рядом с ценой кратко напишите отличие: обычные - статичные, GIF - с движением, премиум - приоритетный заказ и больше правок.
...
Проверьте, что Canva показала сохранение изменений. Публиковать сайт в интернете на этом уроке не нужно.
...
3. В блоке "Пакеты" проверьте три варианта: обычные стикеры, GIF-стикеры, премиум. Если третий вариант еще не добавлен, добавьте например: `Премиум - 2 000 рублей`.
...
В блоке про пакеты опишите 3 варианта: обычные стикеры, GIF-стикеры и премиум. Укажите примерную цену и отличие каждого варианта: обычные стикеры - статичные, GIF-стикеры - с движением, премиум - не зависит от типа стикеров, включает больше правок и приоритет по сроку.
...
#### Если ученик не успел создать сайт или пропустил занятие

Дайте ему резервный макет первого урока: <https://canva.link/eh9oiajheptsake>

Попросите открыть ссылку в браузере и дождаться загрузки Canva.

Если Canva предлагает использовать дизайн как шаблон, ученик нажимает **Использовать шаблон**.

Если открылся обычный проект Canva, ученик открывает меню **Файл** и выбирает **Сделать копию**. На экране этот пункт находится в меню файла слева.

После создания копии ученик нажимает на название проекта в верхней панели и переименовывает его: `Сайт услуги - имя`.

Дальше ученик работает только в своей копии: меняет название услуги, цену, карточки "Что входит", "Почему это стоит денег", "Пакеты" и блок заявки.

#### Если ученик потерял доступ к своему проекту

Сначала попросите открыть Canva и зайти в раздел **Проекты** или **Недавние дизайны**. Ищите проект по названию `Сайт услуги - имя`.

Если проект не найден за 2-3 минуты, не тратьте время урока на долгий поиск. Выдайте резервный макет по ссылке и попросите сделать копию.

Если ученик случайно редактирует общий макет преподавателя, остановите работу и попросите сразу сделать личную копию через **Файл** -> **Сделать копию**.

#### Если ученик путается в финансовой части

Задавайте вопросы по цепочке: что продаем, что входит в заказ, почему это стоит денег, чем обычные стикеры отличаются от GIF-стикеров и премиума.

Не просите ребенка сразу придумать идеальный прайс. Для первого урока достаточно понятной стартовой логики: обычные стикеры - 500 рублей, GIF-стикеры - 1 000 рублей, премиум - 2 000 рублей.

#### Если ученик не справляется с дизайном

Дайте минимальный ориентир: верхний синий блок с названием, желтая цена `от 500 руб.`, три карточки ниже и блок заявки. Смысл важнее украшений.

Напомните: PNG/PDF не подходит как основа для продолжения работы. Для редактирования нужен Canva-проект или копия резервного макета.
